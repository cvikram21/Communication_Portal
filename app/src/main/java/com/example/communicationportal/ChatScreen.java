...
public class ChatScreen extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            try {
                ...
                listMessagesMatchingQuery(mService,"me","chavavikrampvc@gmail.com");
            } catch (Exception e) {
                e.printStackTrace();
            }
            return messages;
        ...
        protected void onPostExecute(List<String> output) {
            ...
            Intent intent = new Intent(ChatScreen.this, FirstScreen.class);
